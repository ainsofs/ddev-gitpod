[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/ainsofs/tree/cms)
...
1. Click on the following link
  https://gitpod.io/#https://github.com/ainsofs/tree/cms
...
1. Gitpod - development environment based on Docker
    1. [.gitpod.yml](https://github.com/ainsofs/tree/cms/blob/main/.gitpod.yml)
    ...
    1. [.gitpod.Dockerfile](https://github.com/ainsofs/tree/cms/blob/main/.gitpod.Dockerfile)
...
1. ddev - ridiculously simple setup for complex development environments, allows developers working locally or working with Gitpod in the cloud.
    1. [.ddev/config.yaml](https://github.com/ainsofs/tree/cms/blob/main/.ddev/config.yaml) - main ddev (default) configuration, can be generated by running `ddev config`
